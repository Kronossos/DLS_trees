...
#   mkdir "test_scenario/$i"
#   mkdir "test_scenario/$i/FHS"
#   mkdir "test_scenario/$i/PG"
    rm -rf test_scenario
    mkdir test_scenario
...
#    do
#      ((name+=1))
#      ../dlsgen/dlsgen2 -gs -da -pilaEv  $g $spec >"test_scenario/$i/PG/PG_$name.txt"
#      ../dlsgen/dlsgen2 -ga -da -pilaEv  $g $spec >"test_scenario/$i/FHS/FHS_$name.txt"
#    done
#
#
#    python3 ../reader.py `ls -d "/home/alek/PycharmProjects/DLS_trees/test_module/test_scenario/$i/FHS/*"` >> test_res/heu_FHS.txt
#    python3 ../reader.py `ls -d "/home/alek/PycharmProjects/DLS_trees/test_module/test_scenario/$i/PG/*"` >> test_res/heu_PG.txt
