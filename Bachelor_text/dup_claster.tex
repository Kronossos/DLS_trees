...
\item Zbiór drzew DLS $\mathcal{T}_i$ dla każdego drzewa genów $G_i \in \mathcal{G}$, reprezentowanych jako wektory  $T = \langle e^1,e^2, \dots , e^m \rangle$, gdzie dla każdego $j$, $e^j$ to liczba epizodów duplikacyjnych przypisanych do węzła $s_j$.
\end{enumerate}}
